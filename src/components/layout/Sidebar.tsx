    ...
    <aside className="hidden lg:flex flex-col w-[260px] h-screen fixed left-0 top-0 z-40 transition-colors duration-300"
      ...
      <div className="px-3 pb-2">
        <Link
          href="/settings"
          className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200
            ${pathname === '/settings' ? 'nav-item-active' : 'hover:opacity-80'}`}
      ...
      {/* Bottom info */}
      <div className="px-4 py-4" style={{ borderTop: '1px solid var(--border-secondary)' }}>
        <div className="flex items-center gap-2 text-xs px-2" style={{ color: 'var(--text-tertiary)' }}>
