  ...
  return (
    <header className="lg:hidden fixed top-0 left-0 right-0 z-40 h-16 px-4 flex items-center justify-between transition-colors duration-300"
      ...
      <div className="flex items-center gap-2">
        <Link 
          href="/sync"
          className="p-2 text-accent bg-accent/10 rounded-full haptic-tap transition-all active:scale-95"
        ...
        <Link 
          href="/settings"
          className="p-2 text-slate-500 hover:text-slate-900 dark:hover:text-white bg-black/5 dark:bg-white/5 rounded-full haptic-tap transition-all active:scale-95"
          title="Ayarlar"
        >
