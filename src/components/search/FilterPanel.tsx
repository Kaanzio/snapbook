      ...
      <div className="flex flex-col gap-6 w-full">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {/* Sort Menu */}
              <div className="relative flex items-center border rounded-xl haptic-tap transition-all hover:bg-black/5 dark:hover:bg-white/5 border-slate-200 dark:border-slate-800">
                <select
