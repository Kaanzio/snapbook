              ...
              return (
                ...
                >
                  <div className="themed-card overflow-hidden">
                    {/* Visual Stack / Grid */}
                    <div className="aspect-[4/3] relative border-b" style={{ background: 'var(--bg-secondary)', borderColor: 'var(--border-secondary)' }}>
                      {collectionPhotos.length > 0 ? (
                        <div className="grid grid-cols-2 h-full gap-0.5">
                          {Array.from({ length: 4 }).map((_, idx) => {
                            const photo = collectionPhotos[idx];
                            return (
                              <div key={idx} className="relative overflow-hidden" style={{ background: 'var(--bg-tertiary)' }}>
                                {photo ? (
                    ...
                    <div className="p-4 flex items-start justify-between gap-3">
                      ...
                      <div className="flex items-center">
                        <button
                          ...
                          title="Düzenle"
                        >
                          <svg className="w-4 h-4 hover:opacity-80 transition-opacity" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
